...
const MathNode = memo(({ data, id, updateNode }) => {
    ...
    return <div className="bg-white border border-red-600  border-black flex flex-col justify-center pb-4 w-64 rounded-sm">
        ...
        <div className="mx-4 my-2">
            ...
            <p className={`text-xs w-fit px-2 rounded-full text-[${Color.MATH_UTILS}] bg-[${Color.MATH_UTILS}10]`}>{data?.func?.Type}</p>
        </div>
